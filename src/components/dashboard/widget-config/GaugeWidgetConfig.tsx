...
import { GaugeWidget } from '../../../types/dashboard';
...
interface GaugeWidgetConfigProps {
  widget: Partial<GaugeWidget>;
  onChange: (field: string, value: any) => void;
}

const GaugeWidgetConfig: React.FC<GaugeWidgetConfigProps> = ({ widget, onChange }) => {
  ...
  const addThreshold = () => {
    ...
    thresholds.push({ value: lastValue, color: '#ef4444' }); // Default to red
    onChange('thresholds', thresholds);
  };
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        <CardTitle>Gauge Widget Configuration</CardTitle>
      </CardHeader>
      <CardContent>
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div>
                <label htmlFor="gaugeType" className="block text-sm font-medium mb-1">Gauge Type</label>
                <Select
                  value={widget.gaugeType || 'radial'}
                  onValueChange={(value) => onChange('gaugeType', value)}
                >
                  <SelectTrigger>
          ...
          {/* Gauge Settings */}
          <div>
            <Heading level={3} className="text-lg font-medium mb-4">Gauge Settings</Heading>
            <div className="space-y-3">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label htmlFor="minValue" className="block text-sm font-medium mb-1">Minimum Value</label>
                  <Input
                    id="minValue"
                    type="number"
                ...
                <div>
                  <label htmlFor="maxValue" className="block text-sm font-medium mb-1">Maximum Value</label>
                  <Input
                    id="maxValue"
                    type="number"
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <label htmlFor="showValue" className="text-sm font-medium">Show Value</label>
              </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              {(!widget.thresholds || widget.thresholds.length === 0) && (
                <p className="text-sm text-gray-500">No thresholds defined. Add thresholds to colorize gauge ranges.</p>
              )}
            </div>
          </div>
...
export default GaugeWidgetConfig;